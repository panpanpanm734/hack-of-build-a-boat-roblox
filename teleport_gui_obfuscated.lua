...
local d=Instance.new("Frame",c)d.Size=UDim2.new(0,150,0,100)d.Position=UDim2.new(0,10,0.5,-50)d.BackgroundColor3=Color3.fromRGB(80,80,80)
...
local n=Instance.new("Frame",c)n.Size=UDim2.new(0,150,0,60)n.Position=UDim2.new(0,10,0.5,70)n.BackgroundColor3=Color3.fromRGB(60,60,60)
local o=Instance.new("TextLabel",n)o.Size=UDim2.new(1,0,0.5,0)o.Position=UDim2.new(0,0,0,0)o.Text="farfarfar"o.BackgroundTransparency=1
...
local q=false
local function r()while q do local j=a.Character local k=g()if j and k then for m=1,5 do if not q then return end j.HumanoidRootPart.CFrame=k.CFrame task.wait(0.4)end if j:FindFirstChild("Humanoid")then j.Humanoid.Health=0 end task.wait(1)end end end
p.MouseButton1Click:Connect(function()q=not q p.Text=q and"Desactivar"or"Activar"if q then task.spawn(r)end end)
a.CharacterAdded:Connect(function(s)local t=s:WaitForChild("Humanoid")t.Health=t.MaxHealth end)
